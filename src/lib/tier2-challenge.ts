...
export const tier2Challenge = {
  ...
  title: "Teams & Script",
  subtitle:
    "Shortlisted teams only. Form your trio, write a script from the prompt, and submit — then take a break.",
  ...
  submission: {
    ...
    intro: "Submit your team script — scan the QR code or open the form below.",
