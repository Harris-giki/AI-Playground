  ...
  return (
    <footer className="site-footer border-t">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-16 pt-14 pb-8">
        ...
        {/* Bottom bar */}
        <div className="site-footer__bar mt-14 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4 border-t">
          <div className="site-footer__meta flex flex-col sm:flex-row items-center gap-2 sm:gap-4">
      ...
      <div className="overflow-hidden select-none pointer-events-none pb-4" aria-hidden>
        <p
          className="site-footer__watermark leading-none text-center"
          style={{
...
function FooterColumn({
  ...
  return (
    <div>
      <p className="site-footer__title mb-4">{title}</p>
