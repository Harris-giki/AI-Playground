    ...
    <div className="tier1-submit-shell tier1-submit-shell--form-only mt-10">
      <div className="tier1-submit-shell__form">
        ...
        <div className="tier1-submit-form-row">
          <a
            href={tier3SubmissionFormUrl}
            target="_blank"
            rel="noopener noreferrer"
            data-hover="SUBMIT"
            className="tier1-qr-link"
            aria-label="Open Tier 3 submission form (QR code)"
          >
            <QRCodeSVG
              value={tier3SubmissionFormUrl}
              size={168}
              level="M"
              fgColor={fg}
              bgColor={bg}
